...
document.getElementById('sendDataBtn').addEventListener('click', function() {
  ...
  tableData.forEach(function(data) {
    const formUrl = 'https://script.google.com/macros/s/AKfycbyL4G9_VDUyr-f3LrP4RIwt6NH5JwteUq8JLKMYEtFlsYUAOLdFlrncPWk3_bxliuwx/exec'; // Replace with your Apps Script Web App URL
    ...
    formData.append('entry.16171819', data.phone);  // Replace with actual entry IDs
